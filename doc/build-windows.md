...
Below are some notes on how to build Lkcoinse Unlimited for Windows.
...
way. This will install to `c:\workspace\lkcoinse`, for example:

    make install DESTDIR=/mnt/c/workspace/lkcoinse
