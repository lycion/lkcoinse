Lkcoinse Core version 0.9.2.1 is now available from:

  https://lkcoinse.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 LCS to 0.01 LCS
...
- Fix "Start lkcoinse on system login"
