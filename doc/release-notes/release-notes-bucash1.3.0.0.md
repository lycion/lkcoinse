Release Notes for Lkcoinse Unlimited Cash Edition 1.3.0.0
=========================================================

Lkcoinse Unlimited Cash Edition version 1.3.0.0 is now available from:
...
This is a major release version based of Lkcoinse Unlimited compatible
...
We have backported an amount of changes from other projects, namely Lkcoinse Core, Lkcoinse ABC and Lkcoinse XT.
