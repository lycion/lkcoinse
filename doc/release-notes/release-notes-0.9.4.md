Lkcoinse Core version 0.9.4 is now available from:

  https://lkcoinse.org/bin/0.9.4/
...
this update is incompatible with the Lkcoinse system and could lead to consensus
forks.

Lkcoinse Core released binaries from https://lkcoinse.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lkcoinse/+archive/ubuntu/lkcoinse
- A third-party or self-compiled Lkcoinse Core

upgrade to Lkcoinse Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
