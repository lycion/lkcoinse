Download URL: https://sourceforge.net/projects/lkcoinse/files/Lkcoinse/lkcoinse-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LCS fee schedule (users still pay 0.01 LCS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #lkcoinse00 - #lkcoinse99
