Lkcoinse version 0.5.4 is now available for download at:
http://sourceforge.net/projects/lkcoinse/files/Lkcoinse/lkcoinse-0.5.4/
...
http://gitorious.org/lkcoinse/lkcoinsed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Lkcoinse-Qt notifications under Growl 1.3.
Increase required age of Lkcoinse-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLkcoinse properly when installing Lkcoinse-Qt over it. (Windows)
