Lkcoinse-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lkcoinse/files/Lkcoinse/lkcoinse-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lkcoinse
...
New/changed settings (command-line or lkcoinse.conf file)
--------------------------------------------------------
