...
This document provides guidelines for internationalization of the Lkcoinse Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lkcoinse_en.ts` remains unchanged.
