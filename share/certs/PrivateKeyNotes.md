...
unlocked to sign the Lkcoinse-Qt.app bundle.
...
allowing somebody to distribute a Lkcoinse-Qt.app or lkcoinse-qt-setup.exe with a valid
...
that the lkcoinse-qt.exe file inside the installer had not been tampered with.
