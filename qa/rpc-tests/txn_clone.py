...
class TxnMallTest(LkcoinseTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 LCS:
        ...
        # 40 LCS serialized is 00286bee00000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Node0's balance should be starting balance, plus 50LCS for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 LCS for 2 matured,
