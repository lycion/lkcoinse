...
class ExcessiveBlockTest (LkcoinseTestFramework):
    ...
    def run_test(self):
        ...
        LkcoinseTestFramework.run_test(self)
        self.testCli()
    ...
    def testExcessiveSigops(self):
        ...
        self.nodes[0].generate(100)  # create a lot of LCS for spending
...
def Test():
    ...
    t.main(["--tmpdir=/ramdisk/test", "--nocleanup", "--noshutdown"], lkcoinseConf, None)
