...
class ValidateblocktemplateTest(LkcoinseTestFramework):
    ...
    def run_test(self):
        ...
        prev_block = block
        # out_value is less than 50LCS because regtest halvings happen every 150 blocks, and is in Satoshis
...
if __name__ == '__main__':
    ...
    ValidateblocktemplateTest().main(args,lkcoinseConf)
