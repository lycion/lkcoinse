...
def p2pkh_list(addr):
    return [OP_DUP, OP_HASH160, lkcoinseAddress2bin(addr), OP_EQUALVERIFY, OP_CHECKSIG]
...
class MyTest (LkcoinseTestFramework):

    def setup_chain(self, lkcoinseConfDict=None, wallets=None):
        print("Initializing test directory " + self.options.tmpdir)
        initialize_chain_clean(self.options.tmpdir, 2, lkcoinseConfDict, wallets)
    ...
    def run_test(self):
        ...
        # lkcoinsed is not sophisticated enough to spend this ^
