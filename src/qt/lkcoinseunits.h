...
#ifndef LKCOINSE_QT_LKCOINSEUNITS_H
#define LKCOINSE_QT_LKCOINSEUNITS_H
...
/** Lkcoinse unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LkcoinseUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LkcoinseUnits(QObject *parent);

    /** Lkcoinse units.
      @note Source: https://en.lkcoinse.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BCH,
...
typedef LkcoinseUnits::Unit LkcoinseUnit;

#endif // LKCOINSE_QT_LKCOINSEUNITS_H
