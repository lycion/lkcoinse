...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    if (LkcoinseUnits::parse(model->getOptionsModel()->getDisplayUnit(), amount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(LkcoinseUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0,
