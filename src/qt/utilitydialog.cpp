 ...
 */
    ...
    else
    {
        ...
        QString header =
            tr("Usage:") + "\n" + "  lkcoinse-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        std::string strUsage = AllowedArgs::LkcoinseQt(&tweaks).helpMessage();
...
void ShutdownWindow::showShutdownWindow(LkcoinseGUI *window)
{
    if (!window)
        return;
