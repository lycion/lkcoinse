// Copyright (c) 2011-2017 The Lkcoinse Unlimited developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LKCOINSE_QT_UNLIMITEDDIALOG_H
#define LKCOINSE_QT_UNLIMITEDDIALOG_H
...
// Minimum time in ms to show notifications (used in LkcoinseGUI not the Unlimited dialog)
