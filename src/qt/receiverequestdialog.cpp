...
#include "config/lkcoinse-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLkcoinseURI(*cfg, info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " +
                LkcoinseUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
void ReceiveRequestDialog::on_btnCopyURI_clicked() { GUIUtil::setClipboard(GUIUtil::formatLkcoinseURI(*cfg, info)); }
