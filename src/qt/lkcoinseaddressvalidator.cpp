...
LkcoinseAddressEntryValidator::LkcoinseAddressEntryValidator(const std::string &_cashaddrprefix, QObject *parent)
    : QValidator(parent), cashaddrprefix(_cashaddrprefix)
{
}

QValidator::State LkcoinseAddressEntryValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
...
LkcoinseAddressCheckValidator::LkcoinseAddressCheckValidator(QObject *parent) : QValidator(parent) {}
QValidator::State LkcoinseAddressCheckValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
    // Validate the passed Lkcoinse address
