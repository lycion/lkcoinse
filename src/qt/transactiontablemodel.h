...
#ifndef LKCOINSE_QT_TRANSACTIONTABLEMODEL_H
#define LKCOINSE_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx,
        ...
        LkcoinseUnits::SeparatorStyle separators = LkcoinseUnits::separatorStandard) const;
...
#endif // LKCOINSE_QT_TRANSACTIONTABLEMODEL_H
