...
{
    ui->setupUi(this);
    ui->uriEdit->setPlaceholderText(GUIUtil::lkcoinseURIScheme(*cfg) + ":");
}
...
void OpenURIDialog::accept()
{
    ...
    QString uriScheme = GUIUtil::lkcoinseURIScheme(*cfg);
    if (GUIUtil::parseLkcoinseURI(uriScheme, getURI(), &rcp))
    {
...
void OpenURIDialog::on_selectFileButton_clicked()
{
    ...
    ui->uriEdit->setText(GUIUtil::lkcoinseURIScheme(*cfg) + ":?r=" + QUrl::toPercentEncoding(fileUri.toString()));
}
