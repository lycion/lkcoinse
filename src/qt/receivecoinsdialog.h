...
#ifndef LKCOINSE_QT_RECEIVECOINSDIALOG_H
#define LKCOINSE_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of lkcoinses */
...
#endif // LKCOINSE_QT_RECEIVECOINSDIALOG_H
