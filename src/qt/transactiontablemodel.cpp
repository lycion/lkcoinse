      ...
      fProcessingQueuedTransactions(false), platformStyle(_platformStyle)
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Address or Label")
            << LkcoinseUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    priv->refreshWallet();
...
{
    columns[Amount] = LkcoinseUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx,
    ...
    LkcoinseUnits::SeparatorStyle separators) const
{
    QString str = LkcoinseUnits::format(
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, LkcoinseUnits::separatorAlways);
        }
        break;
    case Qt::EditRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, LkcoinseUnits::separatorNever);
    case StatusRole:
