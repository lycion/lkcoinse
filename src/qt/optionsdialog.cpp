// Copyright (c) 2011-2015 The Lkcoinse Core, Unlimited, and XT developers
...
/* Window elements init */
    ...
    ui->lkcoinseAtStartup->setToolTip(ui->lkcoinseAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->lkcoinseAtStartup->setText(ui->lkcoinseAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LkcoinseUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->lkcoinseAtStartup, OptionsModel::StartAtStartup);
