...
#ifndef LKCOINSE_WALLET_WALLET_H
#define LKCOINSE_WALLET_WALLET_H
...
//! We can allow a maximum sized free transaction in the Lkcoinse Cash Network.
...
#endif // LKCOINSE_WALLET_WALLET_H
