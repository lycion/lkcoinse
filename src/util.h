 ...
 */
#ifndef LKCOINSE_UTIL_H
#define LKCOINSE_UTIL_H
...
extern const char *const LKCOINSE_CONF_FILENAME;
extern const char *const LKCOINSE_PID_FILENAME;
...
{
    std::string s = strprintf("lkcoinse-%s", name);
