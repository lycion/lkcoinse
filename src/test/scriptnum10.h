...
#ifndef LKCOINSE_TEST_SCRIPTNUM10_H
#define LKCOINSE_TEST_SCRIPTNUM10_H
...
{
    /**
     * The ScriptNum implementation from Lkcoinse Unlimited 0.10.0, for cross-comparison.
     */
public:
