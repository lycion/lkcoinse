...
#ifndef LKCOINSE_CONSENSUS_CONSENSUS_H
#define LKCOINSE_CONSENSUS_CONSENSUS_H
...
/** This is the default max bloom filter size allowed on the lkcoinse network.  In Lkcoinse Unlimited we have the ability
...
#endif // LKCOINSE_CONSENSUS_CONSENSUS_H
