...
{
    ///*
    const char *pszTimestamp = "North Korea's Kim Jong-un agrees to shut missile site 20180919";
    const CScript genesisOutputScript = CScript()
                                        << ParseHex("MHQCAQEEIFLQ60zKuEdgkqwxg2nXp1c1YzIj5mZhhke8VYDC+pTWoAcGBSuBBAAK"
                                                    "oUQDQgAE7DrQCEByiabmTSUOhubjkWQyI97lZbcEo3cKnsOTHajff01KLX8HCXZR"
                                                    "5s6U492DtYY96xAhF4Pp/MtG8FSubg")
                                        << OP_CHECKSIG;
                                        //*/
...
public:
    CMainParams()
    {
        ...
        */
        ...
        pchCashMessageStart[1] = 0xe6;
        pchCashMessageStart[2] = 0xf8;
        pchCashMessageStart[3] = 0xec;
        ...
        /////////GENESIS MINING 2 ///////////////
        ///*
        printf("CMainParams Genesis mining started\n");
        uint32_t nNonce;
        //change the nonce to a random number, will fail otherwise.
        for(nNonce = 157; ; nNonce++)
        {
            genesis.nNonce = nNonce;
            //printf("%d \n", nNonce);
        ...
        // List of Lkcoinse Cash compatible seeders
        //vSeeds.push_back(CDNSSeedData("lkcoinse.info", "lcscash-seeder.lkcoinse.info", true));
        //vSeeds.push_back(CDNSSeedData("lkcoinseabc.org", "seed.lkcoinseabc.org", true));
        //vSeeds.push_back(CDNSSeedData("lkcoinseforks.org", "seed-abc.lkcoinseforks.org", true));
        ...
        checkpointData = (CCheckpointData){
            //boost::assign::map_list_of(0, uint256S("0x00000f1efc1a0268d4f2bb13e404fa6eac7c983dfb51051b8a6a1c91618ff9b8")),
            boost::assign::map_list_of(0, uint256S("0x000002121c6a56318a1c1d9337c9f98165226d37fee75965cee08fe233015228")),
            0, 0, 0};
            //*/
...
public:
    CUnlParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("lkcoinse.info", "nolnet-seed.lkcoinse.info", true));
...
public:
    CTestNetParams()
    {
        ...
        //genesis = CreateGenesisBlock(1537422969, 2083236893, 0x1f00ffff, 1, 250 * COIN);
        genesis = CreateGenesisBlock(1296688602, 414098458, 0x1f00ffff, 1, 250 * COIN);
        

        /////////GENESIS MINING 2 ///////////////
        ///*
        printf("CTestNetParams Genesis mining started\n");
        uint32_t nNonce;
        //change the nonce to a random number, will fail otherwise.
        for(nNonce = 157; ; nNonce++)
        {
        ...
        assert(consensus.hashGenesisBlock ==
               ...
               uint256S("0x00005d791e28c23aff4d7633ba286df20ce83a2ea9f6a806c720b224d842e01b"));
               
        assert(
            //genesis.hashMerkleRoot == uint256S("4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
            genesis.hashMerkleRoot == uint256S("6580c9e9e2099a6581d588db2a6a09f02ae2820888d19efd8ea284de2821ff24"));
        ...
        // Lkcoinse ABC seeder
        vSeeds.push_back(CDNSSeedData("lkcoinseabc.org", "testnet-seed.lkcoinseabc.org", true));
        // lkcoinseforks seeders
        vSeeds.push_back(CDNSSeedData("lkcoinseforks.org", "testnet-seed-abc.lkcoinseforks.org", true));
        // BU seeder
        vSeeds.push_back(CDNSSeedData("lkcoinse.info", "testnet-seed.lkcoinse.info", true));
        // Bitprim
...
public:
    CRegTestParams()
    {
        ...
        /////////GENESIS MINING 2 ///////////////
        ///*
        printf("CRegTestParams Genesis mining started\n");
        uint32_t nNonce;
        //change the nonce to a random number, will fail otherwise.
        for(nNonce = 157; ; nNonce++)
        {
        ...
        assert(consensus.hashGenesisBlock ==
               ...
               uint256S("0x47f4ffad335d86831a49c9c8f96a8ff2df7ae8251e4c2e0e3ddb57c04fedf346"));
               
        assert(
            //genesis.hashMerkleRoot == uint256S("4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
            genesis.hashMerkleRoot == uint256S("c4324b35384fbafa507d8b78f7b2861b807b4fe1b49bedec1b389b8340d4d5a2"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of(0, uint256S("0x47f4ffad335d86831a49c9c8f96a8ff2df7ae8251e4c2e0e3ddb57c04fedf346")),
            0, 0, 0};
