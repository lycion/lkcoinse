...
#ifndef LKCOINSE_SCRIPT_STANDARD_H
#define LKCOINSE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a lkcoinse address
 */
...
#endif // LKCOINSE_SCRIPT_STANDARD_H
