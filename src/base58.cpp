...
void CLkcoinseSecret::SetKey(const CKey &vchSecret)
{
...
bool CLkcoinseSecret::IsValid() const
{
...
bool CLkcoinseSecret::SetString(const char *pszSecret) { return CBase58Data::SetString(pszSecret) && IsValid(); }
bool CLkcoinseSecret::SetString(const std::string &strSecret) { return SetString(strSecret.c_str()); }
