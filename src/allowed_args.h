...
#ifndef LKCOINSE_ALLOWED_ARGS_H
#define LKCOINSE_ALLOWED_ARGS_H
...
class LkcoinseCli : public AllowedArgs
{
public:
    LkcoinseCli();
};

class Lkcoinsed : public AllowedArgs
{
public:
    Lkcoinsed(CTweakMap *pTweaks = nullptr);
};

class LkcoinseQt : public AllowedArgs
{
public:
    LkcoinseQt(CTweakMap *pTweaks = nullptr);
};

class LkcoinseTx : public AllowedArgs
{
public:
    LkcoinseTx();
};
