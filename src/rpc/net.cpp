...
UniValue getaddednodeinfo(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:9773\",  (string) The lkcoinse server host and port\n"
...
// Lkcoinse BUIP010 : End

// Lkcoinse BUIPXXX : Start
...
UniValue getnetworkinfo(const UniValue &params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Lkcoinse:x.x.x/\",     (string) the server subversion string\n"
