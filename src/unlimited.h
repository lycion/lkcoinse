...
#ifndef LKCOINSE_UNLIMITED_H
#define LKCOINSE_UNLIMITED_H
...
extern uint256 lkcoinseCashForkBlockHash;
...
extern void GenerateLkcoinses(bool fGenerate, int nThreads, const CChainParams &chainparams);
